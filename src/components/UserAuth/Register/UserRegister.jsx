            ...
            <div className="screen__content">
                <form className="register" onSubmit={handelLogInSubmit}>
                    <div className="login__field fas" style = {{display: 'flex'}}>
                        ...
                        <input onChange = {handelInputChange} name ='lastName' type="text" className="login__input" placeholder="Lasts Name" />
                    </div>
                    <div className="login__field fas">
                        <MdEmail className = 'login__icon'/>
                        <input onChange = {handelInputChange} name ='email' type="text" className="login__input" placeholder="Email" />
                    </div>
                    <div className="login__field fas">
                    ...
                    <div className="login__field fas">
                        ...
                        <textarea rows = '6' cols = '30' name ='address' onChange = {handelInputChange} type="text" className="login__input" placeholder="Address" />
                    </div>
